class person:
    def __init__(self,name, money, mood, healthRate,lifestyle):
        self.name=name
        self.money=money
        self.mood=mood
...
class Employee(person):
    def __init__(self, name, money, mood, healthRate, emp_id, car, salary, distanceToWork):
...
class Car:
    ...
    def stop(self, remain_distance):
        ...
        if remain_distance > 0:
            print(f"the remaining distance is {remain_distance} km .")
        else:
